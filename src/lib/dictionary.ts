...
export const dictionaries: Record<SupportedLanguage, Dictionary> = {
  kn: {
    ...
    adminHeading: 'A-to-Z ಮಾಸ್ಟರ್ ಅಡ್ಮಿನ್ ಕಂಟ್ರೋಲ್',
    adminSubTitle: 'ದರಗಳ ಬದಲಾವಣೆ, ಆಡ್‌ಸೈನ್ಸ್ ಐಡಿ, ಬ್ಲಾಗ್ ಪಬ್ಲಿಷಿಂಗ್ ಮತ್ತು ಸಿಸ್ಟಮ್ ಕಂಟ್ರೋಲ್',
    passcodeLabel: 'ಅಡ್ಮಿನ್ ಪಾಸ್‌ಕೋಡ್',
    unlockAdmin: 'ಲಾಗಿನ್ ಮಾಡಿ',
    saveChanges: 'ಬದಲಾವಣೆಗಳನ್ನು ಉಳಿಸಿ',
    passcodePlaceholder: '4-ಅಂಕಿಗಳ ಪಾಸ್‌ಕೋಡ್ ನಮೂದಿಸಿ (ಉದಾ: 1234)',
    loginBtn: 'ಅಡ್ಮಿನ್‌ಗೆ ಲಾಗಿನ್ ಮಾಡಿ',
    adminDashboardTitle: 'A-to-Z ಮಾಸ್ಟರ್ ಅಡ್ಮಿನ್ ಕಂಟ್ರೋಲ್ ಡ್ಯಾಶ್‌ಬೋರ್ಡ್',
  ...
  en: {
    ...
    adminHeading: 'A-to-Z Master Admin Dashboard',
    ...
    passcodePlaceholder: 'Enter 4-digit passcode (e.g. 1234)',
    loginBtn: 'Login to Admin',
    adminDashboardTitle: 'A-to-Z Master Admin Dashboard',
